...
rs.getString(11),
    ...
    private void initComponents() {
        ...
        setLocation(new java.awt.Point(330, 145));
        setUndecorated(true);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "name", "mobile", "email", "gender", "nid", "address", "age", "religion", "amount", "gymtime"
            }
        ));
        ...
        jButton2.setText("Download List");
...
try{
 PdfWriter.getInstance(doc, new FileOutputStream(path+"_Member_List.pdf"));
 doc.open();
...
tbl.addCell("gymtime");
    for (int i = 0; i < jTable1.getRowCount(); i++) {
      ...
      String nid=jTable1.getValueAt(i,5).toString();
      String address=jTable1.getValueAt(i,6).toString();
      String age=jTable1.getValueAt(i,7).toString();
      String religion=jTable1.getValueAt(i,8).toString();
      String amount=jTable1.getValueAt(i,9).toString();
      String gymtime=jTable1.getValueAt(i,10).toString();
