...
catch(Exception e)
{
 JOptionPane.showMessageDialog(null, e);
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Gym Schedule");

        jComboBox2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox2.setForeground(new java.awt.Color(0, 0, 153));
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "7am-9am", "9am-11am", "3pm-5pm", "5pm-7pm", "7pm-9pm" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Islam", "Hindu", "Christian", "Others" }));
...
String religion =(String)jComboBox3.getSelectedItem();
